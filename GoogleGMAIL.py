...
smtp_port = 587
smtp_user = 'samueldamaziod@gmail.com'  # Substitua pelo seu endereço de e-mail do Gmail
smtp_password = 'senha'  # Substitua pela sua senha de aplicativo
...
subject = 'Teste de disparo'  # Substitua pelo assunto do seu e-mail
